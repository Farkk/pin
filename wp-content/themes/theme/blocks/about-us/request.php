...
<section class="request-section request-section--about-us" id="request">
  <div class="section-shell">
    <div class="request-grid">
      <div class="request-info request-info--about-us">
      ...
      <form class="request-form request-form--about-us" data-request-form enctype="multipart/form-data">
        <?php theme_render_request_form_meta( 'О компании: заявка' ); ?>
